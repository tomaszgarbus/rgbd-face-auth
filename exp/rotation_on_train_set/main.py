...
def get_no_normalization_models():
    ...
    X_train = np.load(DB_LOCATION + '/gen/rotation_on_train_set_X_train.npy')
    Y_train = np.load(DB_LOCATION + '/gen/rotation_on_train_set_Y_train.npy')
    X_test = np.load(DB_LOCATION + '/gen/rotation_on_train_set_X_test.npy')
    Y_test = np.load(DB_LOCATION + '/gen/rotation_on_train_set_Y_test.npy')
