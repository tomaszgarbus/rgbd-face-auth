\section{Introduction}
    ...
    \subsection{Results}
        ...
        with depth channel.
        However, we also took a closer look at pulse detection with quality RGB camera.

        \subsubsection*{Pulse detection}
            Idea of detecting beating heart was very promising.
            Unfortunately, our research showed that such liveness detection method
            would be too slow for common authentication purposes.
            Also, there was inconvenient requirement for the face to remain
            in one particular spot through the entire procedure.
            This is especially problematic from the camera stabilization perspective.
            Therefore we we abandoned research on this subject.
