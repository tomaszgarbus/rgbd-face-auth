\chapter{Skin recognition}
    ...
    Different types of human skin reflect visible light very differently\cite{hsreflectance},
    ...
    in our experiments. Obviouslyy in our wishful imaginations we had spectrometer
    in mobile device, as it turned out we weren't firs and it's possible \cite{spectrometerphone}.

    Additionally, with the information of which pixel contains human skin,
    it would be possible to use this to remove the background from face photos\cite{colorstudy}.
    ...
    \section{Technical aspect -- how does a camera work?}
        ...
        Such sensors are sensitive to wavelengths approximately up to 1050nm\cite{imagesensorsmax},
        ...
        \subsection*{Multispectral imaging}
            ...
            may see the full spectrum of light (CCD -- $350$-$1050$nm\cite{imagesensorsmax}) and place filters
    ...
    \section{Results}
        ...
        technology may be using hyperspectral camera to find few (like three
        or four) colors giving greater security, as well as measuring
        quality of that solution with fixed number of colors.
        Unfortunately we weren't able to use high quality hyperspectral camera
        to measure possible effectiveness and security of such solutin.
    ...
    \section{RGB skin detection simulation}
        ...
        We based our algorithm on transformation from \textit{Human Skin Detection by Visible and Near-Infrared Imaging}\cite{toyotaskin}:
        \[
            \begin{bmatrix}
                Y \\
                Cb \\
        ...
        However, conditions described in \textit{Human Skin Detection by Visible and Near-Infrared Imaging}\cite{toyotaskin} gave us too many false positives
        ...
        \begin{figure}[H]
            ...
            \centering
            \includegraphics[scale=0.6]{skin_detection_heuristic}
