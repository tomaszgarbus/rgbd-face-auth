\chapter{Skin recognition}
    ...
    \section{RGB skin detection simulation}
        ...
        We based our algorithm on transformation from \citetitle{toyotaskin}:
        \[
            \begin{bmatrix}
                Y \\
                Cb \\
        ...
        However, conditions described in \citetitle{toyotaskin} gave us too many false positives
