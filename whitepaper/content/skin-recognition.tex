\chapter{Skin recognition}
    ...
    \section{Technical aspect -- how does a camera work?}
        ...
        \subsection*{Multispectral imaging}
            ...
            \begin{figure}[H]
                \caption{Visualization of filters mechanism.}
                \centering
        ...
        \subsection*{Hyperspectral imaging}
            ...
            It would be very helpful, in a skin-detection device,
    ...
    \section{Technical aspect -- how can it be created?}
        As we know how a camera works, we can say distinguish two ways of
            ...
            \subsubsection*{Detecting skin -- models}
                ...
                linear kernel it did show some promise.
                 ...
                 \begin{figure}[H]
                    ...
                    \centering
                    \includegraphics[width=11cm]{svm_no_cut}
                ...
                images below.
                  ...
                  \begin{figure}[H]
                    ...
                    The first two pictures come from learning set, others
                    are from test set.}
                    \centering
                ...
                Therefore we consider our results better than expected.
                 ...
                 \begin{figure}[H]
                    ...
                    \centering
                    \includegraphics[width=10cm]{rf_overfitting_op}
