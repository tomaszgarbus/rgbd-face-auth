    ...
    \section{Our attempts}
        ...
        \subsection{Using three infrared wavelengths}
            ...
            \subsubsection*{Detecting skin -- preprocessing}
                ...
                but not negligibly) was taking few values from every
                of three pictures and calculating differences concatenated with basic vector.
            ...
            \subsubsection*{Detecting skin -- models}
                ...
                \begin{figure}[H]
                    \caption{Example of skin-mask.}
                    \centering
                    \includegraphics[width=10cm]{A_mask}
                    \label{fig:A_mask}
                \end{figure}
                ...
                \begin{figure}[H]
                    ...
                    \centering
                    \includegraphics[width=10cm]{rf_good}
                    \label{fig:rf_good}
                \end{figure}
