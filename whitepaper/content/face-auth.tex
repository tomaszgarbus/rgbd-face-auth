\section{Face authentication}
    ...
    \subsection{Classifiers}
        ...
        As an alterative to CNN, to classify HOG feature descriptors, we tested two common (tu jakiś cytat) approaches:
        ...
        After tuning the parameters on final dataset using grid-search approach, following of most important parameters where choesen:
        \begin{itemize}
