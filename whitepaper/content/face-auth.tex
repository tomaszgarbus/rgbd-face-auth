\section{Face authentication}
    ...
    \subsection{Test results}
        \begin{tabular}{ |c|c|c|c|c|c|c|c|c|c|c| }
            ...
            \hline
            CNN & multi-class & y & n & channels & 0.9721 & - & - & - \\
            \hline
            CNN 10 : 1 SVM & multi-class & y & y & channels & 0.9721 & - & - & - \\
            \hline
            CNN 1 : 2 SVM & multi-class & y & y & channels & 0.9536 & - & - & - \\
            \hline
            SVM & multi-class & n & y & channels & 0.9099 & - & - & - \\
            \hline
            SVM 1:10 ET & multi-class & n & y & channels & 0.8884 & - & - & - \\
            \hline
            ET & multi-class & n & y & channels & 0.8369 & - & - & - \\
            \hline
            CNN 1 : 5 SVM & binary & y & y & channels & - & 0.9013 & 0.8947 & 0.8947 \\
            \hline
            CNN & binary & y & y & channels & - & 0.8487 & 0.8487 & 0.8487 \\
            \hline
        \end{tabular}
