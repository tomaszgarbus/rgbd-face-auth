\chapter{Face authentication}
    ...
    \section{Normalization}
        ...
        contains many different angles of each face, rendering this technique unnecessary.
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            ...
            \includegraphics[scale=0.4]{binary_frames_recall_relation_099}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
            \caption{Precision threshold $\geqslant 0.999$}
            \includegraphics[scale=0.4]{binary_frames_recall_relation_0999}
        \end{subfigure}\\
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \caption{Precision threshold $\geqslant 0.9999$}
            \includegraphics[scale=0.4]{binary_frames_recall_relation_09999}
        \end{subfigure}
    \end{figure}
    \newpage
