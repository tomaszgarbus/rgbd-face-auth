\chapter{Face authentication}
    ...
    We have used several different preprocessing techniques.
        ...
        \begin{itemize}
            ...
            \item \textbf{PiecewiseAffine} -- an augmenter that places a regular grid of points on an image and randomly moves the neighbourhood of these point around via affine transformations.
        \end{itemize}
        \begin{figure}[H]
